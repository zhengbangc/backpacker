              ...
              <form role="form" action="" method="POST" name="post_form" onsubmit="return validateForm()">
                <div class="form-group">
                  ...
                  <textarea name="post_content" class="form-control" rows="20" id="comment" placeholder="Share your incredible adventure with the world!" style="width:60%; margin-left:auto; margin-right:auto; margin-bottom:10px"></textarea>
                   <div class="form-group">
                   <input  type="text" name="location" rows = "10" style="margin-left:270px; margin-right:20px; margin-bottom:10px;" placeholder="Location">
                   ...
                   <input type="submit" name="submit" class="btn btn-primary btn-m active" value="post">
                   </div>
                </div>
              ...
              <?php
                      if(isset($_POST['submit']))
                        ...
                        if ($su_username == "" || $su_duration == "" || $su_location=="" || $su_title == "" || $su_content == ""){
                            ...
                            $sql = "INSERT INTO post (writer_username, location, month, duration, cost, content, title) 
                                  VALUES('$su_username','$su_location','$su_month','$su_duration','$su_cost','$su_content','$su_title')";
